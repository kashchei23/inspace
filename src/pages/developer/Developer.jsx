	...
	<div className='page'>
		<main className='developer'>
			<div className='developer-text'>
				...
				<p>
					In addition to React, Javascript, and SCSS, I use tools such as Adobe
				...
				<p>
					This app was inspired by my children, in particular my son, who dreams
					of becoming an astronaut when he grows up. Next stop, Jupiter!
				</p>
				<StyledLink
